 ...
 */
@Controller
@RequestMapping("/bdcTdQsDj")
public class BdcTdQsDjController extends BaseController {
    @Autowired
    ...
    public Object getbdcCfPagesJsonace(Pageable pageable, String xm, String zs, String zl) {
        ...
        return repository.selectPaging("queryBdcTdQsByPage", map, pageable);
    ...
    public Object getBdcdyhxx(String bdcdyid) {
        ...
        return repository.selectOne("getTdBdcdyXxByBdcdyid", map);
    }
}
