 ...
 */
@Controller
@RequestMapping("/bdcFwQsDj")
public class BdcFwQsDjController extends BaseController {
	 	@Autowired
	    ...
	    public Object getbdcCfPagesJsonace(Pageable pageable, String xm, String zs,String zl) {
	        ...
	        return  repository.selectPaging("queryBdcFwQsByPage", map,pageable);
	    ...
	    public HashMap getBdcdyidByProid(String qlr, String qlrzjh) throws Exception {
	        ...
	        resultmap.put(ParamsConstants.BDCDYID_LOWERCASE, bdcdyid.toString().substring(0, bdcdyid.length() - 1));
	        resultmap.put("qlrid", qlrid.toString().substring(0, qlrid.length() - 1));
	        return resultmap;
	    }
	    ...
	    public Object getBdcdyhxx(String bdcdyid){
			...
			return repository.selectOne("getBdcdyFwXxByBdcdyid", map);
	    }
}
