 ...
 */
public interface SelectBdcdyHandleService {
     ...
     */
    void initSelectBdcdyModel(String wiid, String proid, String glbdcdy, String glzs, Model model);
     ...
     */
    void initAddHbXmModel(Model model);
     ...
     */
    Map<String, Object> getDjsjBdcdySearchMap(String djh, String bdcdyh, String dcxc, String qlr, String tdzl, String bdclx, String bdclxdm, String zdtzm,
                                              String htbh, String qlxzdm, String bdcdyhs, String exactQuery, String fwbm);
     ...
     * @return
     * @author <a herf="mailto:jiangganzhi@gtmap.cn">jiangganzhi</a>
     * @description 根据过渡项目ID获取bdcdyid
     */
    String getBdcdyidByGdqlid(String gdqlid);

    /**
     * @param proid 数据源的proid
     * @return
