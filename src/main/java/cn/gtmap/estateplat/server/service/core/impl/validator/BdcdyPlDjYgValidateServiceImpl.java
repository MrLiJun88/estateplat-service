 ...
 */
public class BdcdyPlDjYgValidateServiceImpl implements ProjectValidateService {
    /**
     * @param project 项目信息
     * @return
     * @author <a href="mailto:zhangqiang@gtmap.cn">zhangqiang</a>
    ...
    public Map<String, Object> validate(HashMap param) {
        ...
        if (project != null && StringUtils.isNotBlank(project.getZdzhh())) {
            ...
            List<QllxParent> qllxParentList = qllxParentService.queryZtzcQllxVo(new BdcYg(), querymap);
            if (StringUtils.isNotBlank(project.getDcbIndex())) {
                ...
                List<Map> qllxMapParentList = qllxParentService.queryZtzcQllxMap(new BdcYg(), querymap);
    ...
    public String getDescription() {
        return "验证批量发证的不动产单元是否预告（只针对批量选择楼盘表或者选择逻辑幢）";
    }
}
