 ...
 * @description  组合贷款抵押转移 适用批量抵押转移
 */
public class CreatComplexDyZydjProjectServiceImpl extends CreatProjectDefaultServiceImpl {
    ...
    public List<InsertVo> initVoFromOldData(final Xmxx xmxx) {
        ...
        if (project != null && StringUtils.isNotBlank(project.getProid()) && project.getBdcXmRelList() != null && CollectionUtils.isNotEmpty(project.getBdcXmRelList())) {
            ...
            for (BdcXmRel bdcXmRel : bdcXmRelList) {
                ...
                list = creatProjectHmZydjService.initVoFromOldData(project);
    ...
    public void saveOrUpdateProjectData(final List<InsertVo> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            try {
                ...
                logger.error("CreatComplexDyZydjProjectServiceImpl.saveOrUpdateProjectData",e);
            }
