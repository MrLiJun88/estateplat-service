 ...
 * 批量抵押注销
 */
public class CreatComplexZxTxProjectServiceImpl extends CreatProjectDefaultServiceImpl implements CreatProjectService {
        ...
        if (project != null && StringUtils.isNotBlank(project.getProid()) &&CollectionUtils.isNotEmpty(project.getBdcXmRelList())) {
            ...
            if(CollectionUtils.isNotEmpty(bdcXmRelList)){
                for (BdcXmRel bdcXmRel : bdcXmRelList) {
					...
					if (StringUtils.isNotBlank(project.getSqlx()) && project.getSqlx().equals(Constants.SQLX_PLDYZX))
    ...
    public void saveOrUpdateProjectData(final List<InsertVo> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            try {
                ...
                logger.error("CreatComplexZxTxProjectServiceImpl.saveOrUpdateProjectData",e);
            }
