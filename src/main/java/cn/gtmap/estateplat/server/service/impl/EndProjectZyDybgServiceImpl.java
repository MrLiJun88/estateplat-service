 ...
 * @version 1.1.0, 2019/1/8.
 * @description 转移和抵押变更
 */
public class EndProjectZyDybgServiceImpl extends EndProjectZydjServiceImpl{
    @Autowired
        ...
        if (CollectionUtils.isNotEmpty(bdcXmRelList)) {
            if(qllxVo instanceof BdcDyaq) {
                ...
                for (BdcXmRel bdcXmRel : bdcXmRelList) {
                    ...
                    if (ybdcXm != null) {
                        QllxVo yqllxVo = qllxService.queryQllxVo(ybdcXm);
                        if (yqllxVo != null && (yqllxVo instanceof BdcFdcq || yqllxVo instanceof BdcYg)) {
                            qllxService.changeQllxZt(bdcXmRel.getYproid(), Constants.QLLX_QSZT_HR);
                        }
                    }
                    if (StringUtils.isNotBlank(bdcXmRel.getYqlid())) {
