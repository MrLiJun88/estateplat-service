...
import cn.gtmap.estateplat.server.service.WorkFlowEventService;
...
public class WorkFlowEventServiceImpl implements WorkFlowEventService {
    ...
    @Override
    @Transactional
    public void workFlowEventRegister(String proid, String activityid, String userid, String taskid, String targetActivityDefids) throws Exception {
        Boolean isSz = true;
        String wiid = "";
        String sqlxdm = "";
        ...
        if (isSz&&bdcXm != null) {
            ...
            // 变更和转移合并登记、转移和其他转移合并登记需进行排序，优先改变qlzt
    ...
    @Override
    @Transactional
    public void workFlowEventRegister(String proid, String userid) throws Exception {
        BdcXm bdcXm = bdcXmService.getBdcXmByProid(proid);
        if (bdcXm != null) {
