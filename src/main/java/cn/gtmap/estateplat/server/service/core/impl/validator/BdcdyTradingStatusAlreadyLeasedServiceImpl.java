 ...
 * @version 2019/3/27
 * @description 验证不动产单元交易已租赁状态
 */
public class BdcdyTradingStatusAlreadyLeasedServiceImpl implements ProjectValidateService {
    @Autowired
    ...
    public Map<String, Object> validate(HashMap param) {
        ...
        if (project != null && StringUtils.isNotBlank(project.getBdcdyh())) {
            ...
            if(StringUtils.isNotBlank(tradingStatus)&&StringUtils.equals(tradingStatus,Constants.JYZT_YZL_MC)) {
