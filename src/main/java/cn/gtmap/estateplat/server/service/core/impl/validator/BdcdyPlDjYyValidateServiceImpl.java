 ...
 * @description 批量验证是否预告
 */
public class BdcdyPlDjYyValidateServiceImpl implements ProjectValidateService {
    /**
     * @param project 项目信息
     * @return
     * @author <a href="mailto:zhangqiang@gtmap.cn">zhangqiang</a>
    ...
    public Map<String, Object> validate(HashMap param) {
        ...
        if (project != null && StringUtils.isNotBlank(project.getZdzhh())) {
            ...
            List<QllxParent> qllxParentList = qllxParentService.queryZtzcQllxVo(new BdcYy(), querymap);
            if (StringUtils.isNotBlank(project.getDcbIndex())) {
                ...
                List<Map> qllxMapParentList = qllxParentService.queryZtzcQllxMap(new BdcYy(), querymap);
    ...
    public String getDescription() {
        return "验证批量发证的不动产单元是否异议（只针对批量选择楼盘表或者选择逻辑幢）";
    }
}
