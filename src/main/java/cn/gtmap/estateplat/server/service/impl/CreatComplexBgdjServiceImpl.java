 ...
 * @description 如果多选不动产单元 批量变更统一此逻辑 合并和分割，过渡、新建统一处理,原则为一个项目处理一个不动产单元
 */
public class CreatComplexBgdjServiceImpl extends CreatProjectDefaultServiceImpl{
    @Autowired
                ...
                for (BdcXmRel bdcXmRel : bdcXmRelList) {
                    ...
                    if (StringUtils.isNotBlank(project.getDjId())){
                        ...
                        if (bdcBdcdy!=null){
                            ...
                            if(StringUtils.isNotBlank(bdcBdcdy.getBdcdyh()) && bdcBdcdy.getBdcdyh().substring(0,19).length() > 19){
    ...
    public void saveOrUpdateProjectData(final List<InsertVo> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            try {
                ...
                logger.error("CreatComplexBgdjServiceImpl.saveOrUpdateProjectData",e);
            }
