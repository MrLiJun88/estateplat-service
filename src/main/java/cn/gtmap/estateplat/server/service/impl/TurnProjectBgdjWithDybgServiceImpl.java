 ...
 * @version V1.0, 19-11-16
 */
public class TurnProjectBgdjWithDybgServiceImpl extends TurnProjectDefaultServiceImpl {
    @Autowired
    ...
    public QllxVo saveQllxVo(BdcXm bdcXm) {
        ...
        if (qllxVo instanceof BdcFdcqDz && StringUtils.isNotBlank(bdcXm.getSqlx()) && !StringUtils.equals(bdcXm.getSqlx(), Constants.SQLX_FWFGHBZY_DM)) {
             ...
             *@description 禅道21386 多幢重新读取权籍信息生成bdc_fdcq_dz和bdc_fwfzxx
             */
