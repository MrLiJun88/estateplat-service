...
/**
 * @author <a href="mailto:zhangqiang@gtmap.cn">zdd</a>
 * @version 1.1.0, 2016/4/26.
 * @description 如果处理的是多个不动产单元，批量转移、分割、合并都走这个逻辑进行处理,过渡和新建统一处理逻辑
 */
public class CreatComplexZyProjectServiceImpl extends CreatProjectDefaultServiceImpl {
    @Autowired
    ...
    public void saveOrUpdateProjectData(final List<InsertVo> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            try {
                ...
                logger.error("CreatComplexZyProjectServiceImpl.saveOrUpdateProjectData",e);
            }
