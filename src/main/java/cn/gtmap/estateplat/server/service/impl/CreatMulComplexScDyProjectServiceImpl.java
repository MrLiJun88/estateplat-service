 ...
 */
public class CreatMulComplexScDyProjectServiceImpl extends CreatProjectDefaultServiceImpl {
        ...
        if (project != null && StringUtils.isNotBlank(project.getProid()) && CollectionUtils.isNotEmpty(project.getBdcXmRelList())) {
            ...
            if(CollectionUtils.isNotEmpty(bdcXmRelList)){
                for (BdcXmRel bdcXmRel : bdcXmRelList) {
                    ...
                    list = creatComplexScDyProjectService.initVoFromOldData(project);
    ...
    public void saveOrUpdateProjectData(List<InsertVo> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            try {
                ...
                logger.error("CreatMulComplexScDyProjectServiceImpl.saveOrUpdateProjectData",e);
            }
