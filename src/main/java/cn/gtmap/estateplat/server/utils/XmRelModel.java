...
public class XmRelModel {
    ...
    public static Document getXmRel(List<BdcXmRel> bdcXmRelList, List<HashMap> bdcZsList, List<BdcXm> bdcXmList, List<QllxVo> qllxVoList, List<BdcZdQlzt> bdcZdQlztList, String bdcdyh, List<HashMap> hashMapList,String portalUrl) {
        BdcZdGlService bdcZdGlService = new BdcZdGlServiceImpl();
        String qlr = "";
        String url = portalUrl + "/projectHandle?wiid=";
        //新建文档
                    ...
                    if (bdcXmRel != null) {
                        ...
                        if (StringUtils.isNotBlank(bdcXmRel.getYproid())) {
                            ...
                            if (StringUtils.isNotBlank(groupOneProid) && StringUtils.indexOf(groupOneProid, bdcXmRel.getProid()) > -1 && StringUtils.split(groupOneProid, ",").length > 1) {
                                ...
                                if (bdcXm!=null&&StringUtils.indexOf(groupOneProid, bdcXmRel.getProid()) == 0) {
                                    ...
                                    nodeElement.addAttribute("Url",url+bdcXm.getWiid());
    ...
    private static String getZsxx(HashMap zsMap, BdcXm bdcXm, QllxVo qllxVo, String bdcdyh, String qlr) {
        ...
        if (qllxVo instanceof BdcCf) {
            ...
            if (bdcXm!=null&&!StringUtils.equals(qllxVo.getProid(), bdcXm.getProid())) {
                isjf = true;
            }
    ...
    public static StringBuilder cfInfo(StringBuilder zsxx, QllxVo qllxVo, boolean isjf) {
