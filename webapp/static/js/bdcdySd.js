...
function sdInitTable() {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            {name: 'XZZT', index: 'XZZT', width: '10%', sortable: false},
            ...
            {name: 'XG', index: 'XG', width: '5%', sortable: false,
                formatter: function (cellvalue, options, rowObject) {
                    return '<div style="margin-left:15px;"><div title="修改"  style="float:left;cursor:pointer;" class="ui-pg-div ui-inline-edit" id="" onclick="updateBdcdySd(\'' + rowObject.BDCDYH + '\',\'' + rowObject.QLR + '\',\'' + rowObject.ZL + '\',\'' + rowObject.XZYY + '\')" onmouseover="jQuery(this).addClass(\'ui-state-hover\');" onmouseout="jQuery(this).removeClass(\'ui-state-hover\');"><span class="fa fa-cog fa-lg blue"></span></div></div>';
                }
            }
        ],
        viewrecords: true,
...
function chooseBdcdy(bdcdyh, bdclx, zl,djid,bdclxdm,zdtzm) {
    debugger;
    $('#bdcdyh').val(bdcdyh);
    if (bdcdyh == null || bdcdyh == "undefined")
    {
        bdcdyh = "undefined";
    }
    $.ajax({
        type: "GET",
        url: bdcdjUrl + "/bdcSjgl/getQlrByDjid?djid=" + djid+ "&bdclxdm=" + bdclx + "&zdtzm=" + zdtzm,
        ...
        colModel: [
            {
                ...
                formatter: function (cellvalue, options, rowObject) {
                    if (cellvalue != null && cellvalue != '') {
                        ...
                        cell = '<a href="javascript:chooseBdcdy(\'' + rowObject.BDCDYH + '\',\'' + rowObject.BDCLX + '\',\'' + rowObject.TDZL + '\',\'' + rowObject.ID + '\')" title="' + cellvalue + '" >' + cellvalue + "</a>";
                    }
                    else
                        cell = '';
                    return cell;
