...
//                }
    ...
    $("#dismatch").click(function () {
        ...
        if (gdproid == '' && $("#fw").hasClass("active")) {
            ...
            if (gdproid != '' && $("#fw").hasClass("active")) {
                $.ajax({
                    url: bdcdjUrl+'/bdcJgSjgl/getPpzt?gdproid=' + gdproid,
                    datatype: 'GET',
                    success: function (data) {
                        if (data == '0' || data == '') {
                            tipInfo("该项目未匹配");
...
var disPic = function (gdproid, tdid, lqid, cqid,qlid) {
    ...
    $.ajax({
        url: bdcdjUrl+'/bdcJgSjgl/dismatch',
        type: 'post',
        datatype: 'json',
...
function getSqlxByDjlxAndBdclx(djlx, wfid) {
    ...
    $.ajax({
        type: "GET",
        url: bdcdjUrl+"/bdcJgSjglNt/getSqlxByDjlx",
...
function getDjzxByWfidDjzxdm(wfid, djzxdm) {
    ...
    $.ajax({
        type: "GET",
        url: $("#bdcdjUrl").val() + "/bdcJgSjglNt/getDjzxByWfid",
        data: {wfid: wfid},
        dataType: "json",
        success: function (result) {
            //清空
...
function getDjzxByWfid(wfid) {
    ...
    $.ajax({
        type: "GET",
        url: bdcdjUrl+"/bdcJgSjglNt/getDjzxByWfid",
        data: {wfid: wfid},
        dataType: "json",
        success: function (result) {
            //清空
...
function fwSel(proid, qlrmc, ppzt, djlx, qlid, qlzt, fczh) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.ajax({
                type: "GET",
                url: bdcdjUrl+"/bdcJgSjglNt/getGdFcDjlxToSqlxWfid?djzx=" + djlx,
                dataType: "json",
...
var createXm = function (gdproid, bdcdyh, tdzh, fwid, tdid, qlid, ppzt, gdid, grid_selector, djId) {
    ...
    var options = {
        ...
        success: function (matchData) {
            ...
            $.ajax({
                url: bdcdjUrl+'/bdcJgSjglNt/createCsdj?bdclx=' + $bdclx,
                type: 'post',
                dataType: 'json',
                data: $("#form").serialize(),
                success: function (data) {
...
var createMulXm = function (gdproids,qlids) {
    ...
    var options = {
        ...
        success: function (mulDataFw) {
            ...
            $.ajax({
                url: bdcdjUrl+'/bdcJgSjglNt/createCsdj?lx=' + $bdclx + "&gdFwWay=cg",
                type: 'post',
                dataType: 'json',
                data: $("#form").serialize(),
                success: function (data) {
...
var showMulGdFwPic = function (gdproid,qlid, readOnly) {
    ...
    var sqlx = $("#sqlxSelect").val();
    var url = bdcdjUrl+"/bdcJgSjgl/openMulGdFwPic?gdproid=" + gdproid + "&qlid="+qlid+"&sqlxdm=" + sqlx + "&readOnly=" + readOnly;
    openWin(url, "房屋匹配");
}
//通过房产证号级联不动产单元
...
var updateGdFwAndDyhSel = function (djlx) {
    ...
    $.ajax({
        type: "GET",
        url: bdcdjUrl+"/bdcJgSjgl/getGdfwPpzt?gdproid=" + gdproid,
        dataType: "json",
        success: function (result) {
