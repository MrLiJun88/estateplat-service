...
$(function () {
    ...
    $("#fwTab,#lqTab,#cqTab,#tdTab").click(function () {
        ...
        $.ajax({
            type: "GET",
            url: bdcdjUrl+"/bdcSjglManageBySqlx/getDjlxByBdclx",
            data: {bdclx: $bdclx},
            dataType: "json",
...
//修改按钮点击事件
    $("#gdFwUpdate,#gdLqUpdate,#gdTdUpdate,#gdFwTdUpdate,#gdCqUpdate").click(function () {
        if (this.id == "gdFwUpdate") {
            ...
            addOrUpdate(bdcdjUrl+"/gdXxLr?editFlag=true&bdclx=fw&proid=" + gdproid + "&iscp=false");
...
function getSqlxByDjlxAndBdclx(businessId, wfid) {
    if (businessId == null || businessId == "")
        businessId = $("#djlxSelect  option:selected").val();
    $.ajax({
        type: "GET",
        url: bdcdjUrl+"/bdcSjglManageBySqlx/getSqlxByDjlx",
...
function getDjzxByWfid(wfid) {
    ...
    $.ajax({
        type: "GET",
        url: bdcdjUrl+"/bdcSjglManageBySqlx/getDjzxByWfid",
        data: {wfid: wfid},
        dataType: "json",
        success: function (result) {
            //清空
...
//    判断是否是多个房屋
    $.ajax({
        ...
        success: function (result) {
            ...
            $.ajax({
                type: "GET",
                url: bdcdjUrl+"/bdcSjglManageBySqlx/getGdFcDjlxToSqlxWfid?djlx=" + djlx,
                dataType: "json",
                success: function (sqlxSesult) {
                    ...
                    if (sqlxSesult != null && sqlxSesult != "" && sqlxSesult.businessId != "" && sqlxSesult.businessId != null) {
                        ...
                        $("#djlxSelect option").each(function () {
                            if ($(this).val() == sqlxSesult.businessId) {
