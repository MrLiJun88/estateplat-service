...
(function (factory) {
    ...
    $.extend(Plugin.prototype, {
        ...
        _construct: function () {
            ...
            this.$input = $('<input type="text"' + (isMobile ? 'tabindex="-1"' : '') + ' placeholder="' + p + '" id="combo_'+this.$container.context.id+'" class="' + this.settings.inputClass + '">').appendTo(this.$container)
