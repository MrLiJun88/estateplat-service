<@com.html title="证书销毁台账" import="ace,public">
<style>
    /*移动modal样式*/
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#search").click(function () {
            ...
            var logUrl = "${bdcdjUrl}/zsBhGl/getBdcZsBhXhListByPage?";
    ...
    function logTableInit() {
        ...
        jQuery(grid_selector).jqGrid({
            url: "${bdcdjUrl}/zsBhGl/getBdcZsBhXhListByPage",
            datatype: "json",
            height: 'auto',
            jsonReader: {id: 'LOGID'},
            colNames: [ '销毁证书编号',"销毁人","销毁时间", "见证人"],
            colModel: [
                {name: 'zsbh', index: 'zsbh', width: '30%', sortable: false},
                {name:'xhr',index:'xhr',width:'20%',sortable:false},
                {
                    name: 'xhsj',
                    index: 'xhsj',
                    width: '20%',
                ...
                {name: 'xhjzr', index: 'xhjzr', width: '20%', sortable: false}
            ],
            viewrecords: true,
            rowNum: 10,
            rowList: [10, 20, 30],
