...
<script >
    ...
    <@script name="static/js/jgDataPicForSqlx.js"></@script>
    ...
    <#--图形-->
        ...
        <div class="row">
            <div class="col-xs-6" style="min-width: 350px">
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-name" style="width: 100px">一级类</div>
                    <div class="profile-info-value">
                        <select id="djlxSelect" class="chosen-select" style="width:400px">
                            <#list pfBusinessVoList as pfBusinessVo>
                                <option value="${pfBusinessVo.businessId!}">${pfBusinessVo.businessName!}</option>
                            </#list>
                        </select>
                    </div>
                </div>
            </div>
            <div class="col-xs-2" style="min-width:500px">
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-name">二级类</div>
                    <div class="profile-info-value">
                        <select id="sqlxSelect" class="chosen-select" style="width:350px" onchange="changeSqlx()">
                            <#list sqlxList as sqlx>
        ...
        <div class="row">
            <div class="col-xs-6" style="min-width:700px">
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-name" style="width: 100px"> 三级类</div>
                    <div class="profile-info-value">
                        <select id="djzxSelect" class="chosen-select" style="width:546px" onchange="changeDjlx()">
                            <#list sqlxList as sqlx>
                                <option value="${sqlx.DM!}" name="${sqlx.SQLXDM!}">${sqlx.MC!}</option>
                            </#list>
                        </select>
            ...
            <div class="col-xs-4" style="min-width:300px">
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-name">权利人类型</div>
                    <div class="profile-info-value">
                        <select id="cqgsSelect" class="chosen-select" style="width:245px">
            ...
            <div class="col-xs-10" style="text-align: right;margin-top: 10px">
