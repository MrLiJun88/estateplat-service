<@com.html title="证书领取区间台账" import="ace,public">
<style>
    /*移动modal样式*/
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#search").click(function () {
            ...
            var logUrl = "${bdcdjUrl}/zsBhGl/getBdcZsBhLqqjListByPage?";
    ...
    function logTableInit() {
        ...
        jQuery(grid_selector).jqGrid({
            url: "${bdcdjUrl}/zsBhGl/getBdcZsBhLqqjListByPage",
            datatype: "json",
            height: 'auto',
            jsonReader: {id: 'LOGID'},
            colNames: [ '行政区', "领取人", "领取区间", "领取时间"],
            colModel: [
                {name: 'XZMC', index: 'XZMC', width: '30%', sortable: false},
                {name: 'LQR', index: 'LQR', width: '30%', sortable: false},
                {name: 'LQQJ', index: 'LQQJ', width: '30%', sortable: false},
                {
                    name: 'LQSJ',
                    index: 'LQSJ',
                    width: '30%',
