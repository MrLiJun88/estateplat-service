...
<script type="text/javascript">
    ...
    <@script name="static/js/bdcdySd.js"></@script>
<div class="main-container">
    ...
    <!--修改-->
    <div class="Pop-upBox moveModel" style="display: none;" id="updateSdData">
        <div class="modal-dialog sdSearchPop-modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="ace-icon fa fa-search bigger-110"></i>修改</h4>

                    <button type="button" id="updatesdHide" class="proHide" onclick="closeDialog('updateSdData')"><i
                            class="ace-icon glyphicon glyphicon-remove"></i>
                    </button>
                </div>
                <div class="bootbox-body" style="background: #fafafa;">
    ...
    <div class="Pop-upBox bootbox modal fade bootbox-prompt in newPro" style="display: none;" id="myModal">
        <div class="modal-dialog newPro-modal">
            <div class="modal-content" style="width:900px;">
                ...
                <div class="bootbox-body" style="overflow-y:auto;overflow-x:auto;height:300px; ">
                    <#include "bdcdyListForSd.ftl">
                </div>
            </div>
        </div>
    </div>
