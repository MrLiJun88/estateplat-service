...
<script type="text/javascript">
    ...
    <@script name="static/js/320500/optimization/bdcqzSjsd.js"></@script>
                ...
                <div class="tab-content">
                    <form class="form advancedSearchTable">
                        <div class="row">
                            ...
                            <div class="col-xs-2" style="width: 250px;height: 30px;">
                                <input type="text" id="cqzl" style="width: 250px;height: 30px;">
                            </div>
                        <#--</div>-->
                        <#--<div class="row">-->
                            <div class="col-xs-1" style="width: 270px;">
                                <button type="button" class="btn btn-sm btn-primary"
                                        id="sd_search_btn">搜&nbsp;&nbsp;索
                                    <i class="ace-icon fa fa-search bigger-130"></i>
                                </button>
                                <label><input type="checkbox" id="exactQueryBdcqzSd" select/>精确查询</label>
                            </div>
                        </div>
                    </form>
