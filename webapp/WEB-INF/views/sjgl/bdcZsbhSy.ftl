...
<script type="text/javascript">
    ...
    <@script name="static/js/bdcZsbhSy.js"></@script>
                            ...
                            <tr>
                                <td>
                                    <input type="text" class="SSinput watermarkText" id="sd_search"
                                           data-watermark="请输入证书编号/不动产单元号/产权证号">
                                </td>
                                <td class="Search">
                ...
                <div class="bootbox-body" style="background: #fafafa;">
                    <form class="form advancedSearchTable" id="sdSearchForm">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <input type="text" name="fzr" id='searchFzr' class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-2">
                            ...
                            <div class="col-xs-4">
                                <input type="text" name="zsbh" id='searchZsbh' class="form-control">
                            </div>
                        </div>
                    </form>
                </div>
