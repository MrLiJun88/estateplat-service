...
<style>
    ...
    .bg{ background:#FFF url(${platformUrl!}/pf/images/signback.gif) no-repeat fixed 0 -160px;}
...
<div id="lyrsigntemp" class="signdiv" style="position:absolute;left:40px;top:50px;width:400px;height:160px;z-index:0">
