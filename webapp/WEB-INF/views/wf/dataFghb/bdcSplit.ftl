<@com.html title="不动产登记业务管理系统" import="bootstrap,public">
    ...
    <script type="text/javascript" src="${bdcdjUrl!}/static/js/bdcFghb/bdcSplit.js"></script>
    <script type="text/javascript" src="${bdcdjUrl!}/static/js/bdcFghb/bdcSplit_grid.js"></script>
            ...
            <div class="span10 right">
                ...
                <div class="tabbable">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tab3" data-toggle="tab" id="splitTab">分割</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="splitModel">
                            <p>其它</p>
                        </div>
                    </div>
                </div>
