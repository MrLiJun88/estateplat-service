...
<script type="text/javascript">
    ...
    function printBysl() {
        var proid = "${proid!}";
        var url = "${reportUrl!}/ReportServer?reportlet=print%2Fbdc_yyzxgg.cpt&proid=" + proid+'&wiid='+wiid;
        openWin(url);
    }
</script>
            ...
            <@f.table style="width:650px">
                ...
                <tbody id="bdcqk">
                    <#list resultList as value>
                        ...
                        <@f.td colspan="1" >
                            <@f.text  id="bdcqzh_${value.bdcZs.zsid!}" name="ggnr" value="${value.bdcZs.bdcqzh!}" style="text-align:center"></@f.text>
                        </@f.td>
                        <@f.td colspan="1" >
