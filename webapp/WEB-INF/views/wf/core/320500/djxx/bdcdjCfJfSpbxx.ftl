...
<script type="text/javascript" xmlns="http://www.w3.org/1999/html">
    ...
    function saveBdcCfJfSpbxx() {
        ...
        $.ajax({
            url: "${bdcdjUrl}/bdcdjSpbxx/saveBdcCfSpbxx",
            type: 'POST',
            dataType: 'json',
    ...
    function openCfJfspb(){
        var url = "";
        if("${isJf!}" == "true")
            url = reportUrl + "/ReportServer?reportlet=print%2Fbdc_jfshb.cpt&op=write&proid=" + proid;
        else
            url = reportUrl + "/ReportServer?reportlet=print%2Fbdc_cfshb.cpt&op=write&proid=" + proid;
        openWin(url);
    }
...
<div class="bs-docs-example toolTop">
    <div class="leftToolTop">
        <button type="button" class="btn btn-info save" onclick="saveBdcCfJfSpbxx()">保存</button>
    </div>
    <div class="rightToolTop">
        <div class='btn-group'>
            <a class='btn btn-success' class="dropdown-toggle" data-toggle="dropdown" onclick="openCfJfspb()">打印</a>
...
<div class="main-container">
    <@f.contentDiv  title="不动产查封登记审核表">
        <@f.form id="spbForm" name="spbForm">
            ...
            <@f.hidden id="sqlx" name="sqlx" value="${bdcXm.sqlx!}"/>
            ...
            <@f.table style="width:650px">
                ...
                <@f.tr>
                    <@f.th rowspan="8" colspan="1">
                        <@f.label name="不动产情况" style="margin:0 auto;width:20px;line-height:24px;border:0px solid #333"></@f.label>
                    </@f.th>
                    <@f.th colspan="3">
                ...
                <@f.tr>
                    <@f.th rowspan="5" colspan="1" >
                        <@f.label name="查封情况" style="margin:0 auto;width:20px;line-height:24px;border:0px solid #333"></@f.label>
                    </@f.th>
                    <@f.th colspan="3">
                ...
                <@f.tr>
                    <@f.th rowspan="5" colspan="1" >
                        <@f.label name="解封情况" style="margin:0 auto;width:20px;line-height:24px;border:0px solid #333"></@f.label>
                    </@f.th>
                    <@f.th colspan="3">
                ...
                <@f.tr>
                    <@f.th colspan="3">
                        <@f.label name="解封时间"></@f.label>
                    </@f.th>
                    <@f.td colspan="9">
                        <@f.date  id="jfsj" name="jfsj" value="${jfsj!}"></@f.date>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th colspan="3">
                    ...
                    <@f.td colspan="9">
                        <@f.textarea  id="bz" name="bz" value="${bdcCf.bz!}"></@f.textarea>
                    </@f.td>
                </@f.tr>
                </#if>
                <@f.tr>
                    <@f.th rowspan="6" colspan="1" >
                        <@f.label name="不动产登记审批情况" style="margin:0 auto;width:20px;line-height:24px;border:0px solid #333"></@f.label>
                    </@f.th>
