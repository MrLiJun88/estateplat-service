        ...
        <#--</@f.buttons>-->
            ...
            <@f.table>
                ...
                <@f.tr>
                    ...
                    <@f.td>
                        <@f.text id="bdcqzh" name="bdcqzh" value=""  readonly="true"></@f.text>
                    </@f.td>
                    <@f.th>
                ...
                <@f.tr>
                    ...
                    <@f.th>
                        <@f.label name="货币单位"></@f.label>
                    </@f.th>
                    <@f.td>
                        <@f.text id="hbdw" name="hbdw" value="${bdcDyaq.hbdw!}"></@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                    ...
                    <@f.th>
                        <@f.label name="注销抵押业务号"></@f.label>
                    </@f.th>
                    <@f.td>
                        <@f.text id="zxdyywh" name="zxdyywh" value="${bdcDyaq.zxdyywh!}"></@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                ...
                <@f.tr>
                    <@f.th>
                        <@f.label name="在建建筑物坐落"></@f.label>
                    </@f.th>
                    <@f.td colspan="3">
                        <@f.text> ${bdcDyaq.zjgczl!}</@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                    ...
                    <@f.td>
                        <@f.text  name="djyy" value="${bdcXm.djyy!}"/>
                    </@f.td>
                    <@f.th>
                        <@f.label name="分摊土地面积"></@f.label>
                    </@f.th>
                    <@f.td>
                        <@f.text id="fttdmj" name="fttdmj" value="${bdcDyaq.fttdmj!}"></@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                ...
                <@f.tr>
                    <@f.th>
                        <@f.label name="抵押不动产权证号"></@f.label>
                    </@f.th>
                    <@f.td colspan="3">
                        <@f.text> ${bdcXm.yfczh!}</@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                    ...
                    <@f.td colspan="9">
                        <@f.textarea  name="qlqtzk" id="qlqtzk">${bdcSpxx.qlqtzk!}</@f.textarea>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                ...
                <@f.tr>
                    <@f.th>
                        <@f.label name="是否融资"></@f.label>
                    </@f.th>
                    <@f.td colspan="3">
                        <select id="sfrz" name="sfrz"  value="${bdcDyaq.sfrz!}">
