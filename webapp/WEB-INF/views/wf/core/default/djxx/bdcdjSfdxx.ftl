<@com.html title="不动产登记业务管理系统" import="ace,public,init,authorize,fr">
...
//        sl改变时重新计算缴费金额
    ...
    function qlrsfAdd() {
        ...
        var tr = '<tr id="' + row_num + '" >'
                ...
                + '<a  id="qlrsfxm_del"name="qlrsfxm_del"onclick="sfDel(' + e + ')"><i class="ace-icon glyphicon glyphicon-remove"></i></a> '
                + '</td></tr>';
        ++e;
    ...
    function ywrsfAdd() {
        ...
        var tr = '<tr id="' + row_num + '" >'
                ...
                + '<td style="border-left:none;text-align:center;">'
                + '<a  id="ywrsfxm_del"name="ywrsfxm_del"onclick="sfDel(' + e + ')"><i class="ace-icon glyphicon glyphicon-remove"></i></a> '
                + '</td></tr>';
        ++e;
...
//                    window.location.reload();
    ...
    function  printSfd() {
        ...
        p.push("{reportlet: '/edit/bdc_sjtzd.cpt', proid : '" + proid + "'}");
        //将参数值组成的数组转化为字符串
        var rp = p.join(",");
...
<div class="bs-docs-example toolTop">
    <div class="leftToolTop">
        <button type="button" class="btn btn-info save" id="提交"name="提交"onclick="saveSfxx()">保存</button>
    </div>
    <div class="rightToolTop">
        <div class='btn-group'>
            <a  class='btn btn-success' class="dropdown-toggle"  data-toggle="dropdown" id="打印预览"name="打印预览"onclick="printSfd()">打印</a>
            ...
            <@f.table style="width:650px">
                ...
                <@f.tr>
                    ...
                    <@f.th style="border-left:none">
                        <a id="qlrsfxm_add"name="qlrsfxm_add"onclick="qlrsfAdd()"><i class="ace-icon glyphicon glyphicon-plus"></i></a>
                    </@f.th>
                </@f.tr>
                <#if (qlrbdcSfxmList?size > 0)>
                    <#list qlrbdcSfxmList as qlrsf>
                        <@f.tr id="tr_${qlrsf.sfxmid!}">
                            ...
                            <@f.td style="border-left:none;text-align:center;">
                                <a id="qlrsfxm_del"name="qlrsfxm_del"onclick="sfDel('${qlrsf.sfxmid!}')"><i class="ace-icon glyphicon glyphicon-remove"></i></a>
                            </@f.td>
                        </@f.tr>
                    </#list>
                <#else>
                    <@f.tr id="tr_def1">
                        ...
                        <@f.td style="border-left:none;text-align:center;">
                            <a id="qlrsfxm_del"name="qlrsfxm_del"onclick="sfDel('def1')"><i class="ace-icon glyphicon glyphicon-remove"></i></a>
                        </@f.td>
                    </@f.tr>
                </#if>
                <@f.tr id="tr_qlr">
                    ...
                    <@f.td colspan="6">
                        <@f.text id="hj" name="zj" value=""></@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                    ...
                    <@f.td colspan="6">
                        <@f.text id="qlrmc" name="ywrmc" value="${comywr!}"></@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
                    ...
                    <@f.th style="border-left:none">
                        <a id="ywrsfxm_add"name="ywrsfxm_add"onclick="ywrsfAdd()"><i class="ace-icon glyphicon glyphicon-plus"></i></a>
                    </@f.th>
                </@f.tr>
                <#if (ywrbdcSfxmList?size > 0)>
                    <#list ywrbdcSfxmList as ywrsf>
                        <@f.tr id="tr_${ywrsf.sfxmid!}">
                            ...
                            <@f.td style="border-left:none;text-align:center;">
                                <a id="ywrsfxm_del"name="ywrsfxm_del"onclick="sfDel('${ywrsf.sfxmid!}')"><i class="ace-icon glyphicon glyphicon-remove"></i></a>
                            </@f.td>
                        </@f.tr>
                    </#list>
                <#else>
                    <@f.tr id="tr_def2">
                        ...
                        <@f.td style="border-left:none;text-align:center;">
                            <a id="ywrsfxm_del"name="ywrsfxm_del"onclick="sfDel('def2')"><i class="ace-icon glyphicon glyphicon-remove"></i></a>
                        </@f.td>
                    </@f.tr>
                </#if>
                <@f.tr id="tr_ywr">
                    ...
                    <@f.td colspan="6">
                        <@f.text id="hj_y" name="zj" value=""></@f.text>
                    </@f.td>
                </@f.tr>
                <@f.tr>
                    <@f.th>
