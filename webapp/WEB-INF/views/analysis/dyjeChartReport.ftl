...
<script>
    $(function(){
        mainContainerHeight();
        $("#iframe").attr("src", "${reportUrl!}/ReportServer?reportlet=analysis%2Ftj_dyje_xm.cpt&op=write&"+$("#form").serialize());
        ...
        <form class="form" id="form">
            <div class="row">
                <div class="form-group">
                    ...
                    <label class="col-xs-1 control-label no-padding-right">抵押类型：</label>
                    <div class="col-xs-1">
                    <span class="input-icon">
                        <select name="dyfs" class="form-control" id="dyfsSel">
                            <option></option>
                            <#list dyfsList as dyfs>
                                <option value="${dyfs.DM}">${dyfs.MC}</option>
                            </#list>
                        </select>
                    </span>
                    </div>
