...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#search").click(function () {
            ...
            var Url = "${bdcdjUrl}/bdcSjSd/getBdcdySdPagesJson?bh=" + $("#bh").val() + "&" + $("#gjSearchForm").serialize();
        ...
        jQuery(grid_selector).jqGrid({
            url: "${bdcdjUrl}/bdcSjSd/getBdcdySdPagesJson?bh=${bh!}&bdcdyh=${bdcdyh!}",
            datatype: "json",
            height: 'auto',
            jsonReader: {id: 'BDCDYID'},
            colNames: ['权利人', '不动产单元号', '坐落', '锁定人', '冻结原因', '冻结状态', 'PROID', 'BDCLX', 'WIID', 'BDCDYID'],
            colModel: [
                ...
                {name: 'XZYY', index: 'XZYY', width: '5%', sortable: false, hidden: false},
                {
    ...
    function unlockBdcdyXzzt(bdcdyid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                alert(data.message);
                var url = "${bdcdjUrl}/bdcSjSd/getBdcdySdPagesJson?proid=${bh!}";
    ...
    function lockBdcdyXzzt(bdcdyid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                alert(data.message);
                var url = "${bdcdjUrl}/bdcSjSd/getBdcdySdPagesJson?bh=${bh!}";
                tableReload("grid-table", url, {hhSearch: ''}, '', '');
            },
            error: function (data) {
                //alert('');
    ...
    function ensureSearch() {
        ...
        var Url = "${bdcdjUrl}/bdcSjSd/getBdcdySdPagesJson?proid=${bh!}&" + $("#gjSearchForm").serialize();
