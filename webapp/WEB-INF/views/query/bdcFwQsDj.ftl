...
$(function () {
	...
	$("#gjSearchBtn").click(function () {
		var Url = "${bdcdjUrl}/bdcFwQsDj/getbdcCfPagesJsonace?" + $("#gjSearchForm").serialize();
	...
	jQuery(grid_selector).jqGrid({
		url:"${bdcdjUrl}/bdcFwQsDj/getQlrJsonace",
		datatype:"json",
		height:'auto',
...
function getBdcdyhxx(bdcdyid,table, rowid) {
    $.ajax({
        type:"GET",
        url:"${bdcdjUrl}/bdcFwQsDj/getBdcdyhxx?bdcdyid=" + bdcdyid,
        dataType:"json",
...
function serch() {
	...
	var Url = "${bdcdjUrl}/bdcFwQsDj/getQlrJsonace";
