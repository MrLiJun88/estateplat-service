...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#search").click(function () {
            ...
            var Url = "${bdcdjUrl}/queryZxFw/getDyaqPagesJson?wiid=${ywiid!}";
    ...
    $(function(){
        ...
        jQuery(grid_selector).jqGrid({
            url:"${bdcdjUrl}/queryZxFw/getDyaqPagesJson?wiid=${ywiid!}",
            datatype:"json",
            height:'auto',
            jsonReader:{id:'PROID'},
            colNames:["proid",'不动产单元号', '不动产权证号','坐落','权利人'],
            colModel:[
                {name:'PROID', index:'PROID', width:'0%', hidden:true},
                {name:'BDCDYH', index:'BDCDYH', width:'20%', sortable:false},
                {name:'BDCQZH', index:'BDCQZH', width:'23%', sortable:false},
    ...
    function ywsjInitTable(tableKey) {
        ...
        jQuery(grid_selector).jqGrid({
            url:"${bdcdjUrl}/queryZxFw/getDyaqPagesJson?dyid=${dyid!}",
            datatype:"json",
            height:'auto',
            jsonReader:{id:'PROID'},
            colNames:["proid",'不动产单元号', '不动产权证号', '坐落','权利人'],
    ...
    function ywsjEditXm(ids) {
        ...
        $.blockUI({ message:"请稍等……" });
        var options = {
            url:'${bdcdjUrl}/queryZxFw/changeQszt?proid='+proid+"&wiid="+wiid+"&ids="+ids+"&xmly=1",
            type:'post',
            dataType:'json',
...
<input type="hidden" id="ywiid" value="${ywiid!}">
    ...
    <div class="page-content">
        <div class="simpleSearch">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td>
                        <input type="text" class="SSinput watermarkText" id="search_xmmc" data-watermark="请输入不动产单元号/不动产权证号/坐落">
                    </td>
