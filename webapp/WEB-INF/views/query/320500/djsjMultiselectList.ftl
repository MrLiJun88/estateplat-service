...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#djsjTab,#ywsjTab,#qlxxTab,#gdfcsjTab,#gdtdsjTab,#hhcfsjTab").click(function () {
            ...
            if (this.id == "djsjTab") {
                ...
                var url = "${bdcdjUrl}/selectBdcdy/showHhcf?proid=${proid!}";
                $("#hhcf").attr("src", url);
            }
            $mulData = new Array();
            $mulRowid = new Array();
    ...
    function getGdCfCqzh(rowid,bdcdyid,gdproid,table){
        $.ajax({
            type: "GET",
            url: "${bdcdjUrl}/selectBdcdy/getGdCfCqzh?bdcdyid=" + bdcdyid + "&gdproid=" + gdproid,
            success: function (result) {
                debugger;
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    <#elseif bdcdyly==4>
                        ...
                        <li>
                            <a data-toggle="tab" id="hhcfsjTab" href="#hhcfsj">
                                查看查封清单
                            </a>
                        </li>
                    <#elseif bdcdyly==5>
