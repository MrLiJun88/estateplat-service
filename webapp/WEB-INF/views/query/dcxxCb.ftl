                ...
                <div class="bs-docs-sidebar" style="position: fixed;top: 15px;right:20px">
                    <ul id="menu"
                        ...
                        <li class="ui-menu-item">
                            <a href="#cbxx" class="ui-corner-all" tabindex="-1" role="menuitem">土地承包信息</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <section id="cbxx">
                        <div class="row-fluid" align="center">
                            <iframe name="myModalFrame"
                                    src="${reportUrl}/ReportServer?reportlet=edit%2Fbdc_cbdcb.cpt&op=write&proid=${proid}"
                                    width=655px height="1000px"
