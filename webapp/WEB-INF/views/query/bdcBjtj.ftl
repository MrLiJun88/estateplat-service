...
<script type="text/javascript">
    $(function () {
		...
		if(records>0){
			var Url="${bdcdjUrl}/bdcbjtj/exporExcel?cxjssj="+cxjssj+"&cxqssj="+cxqssj;
			window.open(Url);
	  }
	})
        //项目高级搜索关闭事件
        ...
        jQuery(grid_selector).jqGrid({
            url:"${bdcdjUrl}/bdcbjtj/getBdcdjtjPagesJson",
            datatype:"json",
            height:'auto',
            jsonReader:{id:'WIID'},
            colNames:["项目名称",'时限要求','序号','申请人姓名','联系电话','受理日期','办结日期','未办结原因','备注','wiid'],
            colModel:[
                {name:'SQLX', index:'SQLX', width:'10%', sortable:false},
                {name:'BLSX', index:'BLSX', width:'8%', sortable:false},
                {name:'ROWNUM', index:'ROWNUM', width:'8%', sortable:false},
                {name:'QLRMC', index:'QLRMC', width:'7%', sortable:false},
                {name:'QLRLXDH', index:'QLRLXDH', width:'15%', sortable:false},
                {name:'CJSJ', index:'CJSJ', width:'10%', sortable:false},
                {name:'BJSJ1', index:'BJSJ1', width:'10%', sortable:false},
                {name:'WBJYY', index:'WBJYY', width:'10%', sortable:false},
                {name:'BZ', index:'BZ', width:'10%', sortable:false},
                {name:'WIID', index:'PROID', width:'10%', sortable:false,hidden :true},
            ],
            viewrecords:true,
            rowNum:10,
            rowList:[10,20,30],
    ...
    function serch(){
        var cxjssj = $("#cxjssj").val();
        var cxqssj = $("#cxqssj").val();
        var Url = "${bdcdjUrl}/bdcbjtj/getBdcdjtjPagesJson";
...
<div class="main-container">
	<div class="page-content">
		<div class="simpleSearch" style ="height:60px ;width:900px">
			 <div class="bootbox-body" style="background: #fafafa;">
                    ...
                    <div class="col-xs-1 search">						 
                        <button type="button" id="export" style="border: 0px;width:80px;white-space: nowrap;">
