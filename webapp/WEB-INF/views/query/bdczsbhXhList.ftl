<@com.html title="证书编号销毁台账" import="ace,public">
<style>
    /*移动modal样式*/
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#search").click(function () {
            ...
            var logUrl = "${bdcdjUrl}/zsBhGlNew/getBdcZsBhXhListByPage?";
    ...
    function logTableInit() {
        ...
        jQuery(grid_selector).jqGrid({
            url: "${bdcdjUrl}/zsBhGlNew/getBdcZsBhXhListByPage",
            datatype: "json",
            height: 'auto',
            jsonReader: {id: 'LOGID'},
            colNames: [ '销毁证书类型', "证本编号", "销毁时间", "销毁人","见证人"],
            colModel: [
            ...
            if (value == "zs")
                ...
                {name: 'ZSBH', index: 'ZSBH', width: '30%', sortable: false},
                {name: 'XHRQ', index: 'XHRQ', width: '30%', sortable: false,formatter: function (cellvalue, options, rowObject) {
                    if (!cellvalue) {
                        return "";
                    }
                    var value = cellvalue;
                ...
                {name: 'XHR', index: 'XHR', width: '30%', sortable: false},
                {name: 'XHJZR', index: 'XHJZR', width: '30%', sortable: false}
            ],
            viewrecords: true,
            rowNum: 10,
            rowList: [10, 20, 30],
