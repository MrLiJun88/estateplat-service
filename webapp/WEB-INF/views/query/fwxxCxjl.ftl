...
<script type="text/javascript">
    $(function () {
        ...
        jQuery(grid_selector).jqGrid({
            url:"${bdcdjUrl}/fwxxcxjl/queryfwCxjl",
            datatype:"json",
            height:'auto',
            jsonReader:{id:'JLID'},
            colNames:["查询人姓名",'查询时间','申请人姓名','查询坐落','查询结果','jlid'],
            colModel:[
                ...
                {name:'CXZL', index:'CXZL', width:'15%', sortable:false},
                {name:'XXNR', index:'XXNR', width:'10%', sortable:false},
    ...
    function serch(){
        ...
        var Url = "${bdcdjUrl}/fwxxcxjl/queryfwCxjl";
